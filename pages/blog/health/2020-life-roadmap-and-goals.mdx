...
export const meta = {
    date: 'January 8, 2020',
    description: 'Happy New Year everyone! I thought that it would be a great idea to write a blog post and make a video about my goals for 2020. Which is why I have named this post “2020 Life Roadmap & Goals”',
    image: '',
...
export default ({ children }) => <BlogLayout meta={meta} bg='muted'>{children}</BlogLayout> 
