...
export const meta = {
    ...
    description:
        'Recently I went in to get some blood work done since I haven not in over 3 years. I was shocked to see that I had high cholesterol.',
    image: '/bloodWork.png',
    title: 'Blood Work for the New Year',
    readTime: 4,
